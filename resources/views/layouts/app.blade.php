...
<body>
    <div id="app">
        ...
        @if (!Auth::guest())
        <div class="sidenav">
          <p> <router-link :to="{ name: 'ProfitLoss' }">Profit & Loss</router-link></p>
          ...
          <button class="dropdown-btn">Balance Sheeet   <i class="fa fa-caret-left" style="padding-top:7px ; float:right"></i></button>
          <div class="dropdown-container">
            <p> <router-link :to="{ name: '' }">Assets</router-link></p>
            <p> <router-link :to="{ name: 'Liabilities' }">Liability</router-link></p>
            <p> <router-link :to="{ name: 'Balancesheet' }">View Balance Sheet </router-link></p>
          </div>
